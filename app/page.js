        ...
        <div className="container grid-2">
          ...
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 }}>
              ...
              <img src="/images/joe-with-customers.jpg" alt="Joe with happy customers" style={{ width: "100%", height: 200, objectFit: "cover", objectPosition: "center 40%", borderRadius: 10 }} />
            </div>
      ...
      <section style={{ padding: "60px 24px", background: "#0d0d0d" }}>
        <div className="container grid-2" style={{ alignItems: "center" }}>
          ...
          <div style={{ background: "linear-gradient(160deg, #fce4ef 0%, rgba(247,37,133,0.15) 100%)", padding: 40, textAlign: "center", border: "1px solid rgba(247,37,133,0.2)" }}>
            <img src="/images/princess-packing-crew.jpg" alt="Princess Packing crew in pink polos" style={{ width: "100%", height: 280, objectFit: "cover", objectPosition: "center 40%" }} />
