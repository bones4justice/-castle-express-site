      ...
      <section className="section">
        <div className="container-sm">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 40, borderRadius: 12, overflow: "hidden" }}>
            ...
            <img src="/images/joe-with-customers.jpg" alt="Joe with happy customers" style={{ width: "100%", height: 220, objectFit: "cover" }} />
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 40, borderRadius: 12, overflow: "hidden" }}>
            ...
            <img src="/images/crew-furniture.jpg" alt="Crew with furniture" style={{ width: "100%", height: 160, objectFit: "cover" }} />
