...
export const SERVICE_PAGES = {
  "residential-moving": {
    ...
    metaTitle: "Residential Movers in CT & MA | Castle Express",
    metaDesc: "Residential movers for Hartford County CT & Western MA since 2011. Houses, apartments, condos & senior moves. 200+ five-star reviews. (888) 553-4503",
    heroImage: "/images/truck-residential.jpg",
    intro: "Moving is one of life's biggest transitions  -  and Castle Express has been helping Connecticut and Massachusetts families navigate it since 2011. Whether you're moving across town or across the state, our professional crews handle every detail so you can focus on settling into your new home.",
    sections: [
      {
  ...
  "commercial-moving": {
    ...
    metaTitle: "Commercial & Office Movers in CT | Castle Express",
    metaDesc: "Commercial & office movers for CT & Western MA. Minimal downtime, experienced crews, planning around your schedule. 200+ reviews. (888) 553-4503",
  ...
  "packing-services": {
    ...
    metaTitle: "Full-Service Packing in CT | Castle Express",
    metaDesc: "Full-service & partial packing, all materials included. Princess Packing™ white-glove service available. Hartford County CT & Western MA. (888) 553-4503",
    ...
    sections: [
      {
        ...
        items: [
          "Climate-controlled environment  -  held between 55 and 85 degrees with regulated humidity, all year",
          "Secure wooden vault storage  -  your items sealed in dedicated, numbered containers",
          "24/7 facility monitoring",
          "5,000 sq ft warehouse at our home base: 4 Niblick Rd, Enfield, CT",
          "Convenient Enfield, CT location off I-91",
        ],
      },
      {
        heading: "How Moving Into Storage Works",
        items: [
          "Our crew picks everything up  -  no rental truck, no loading a unit yourself",
          "Items are padded, wrapped, and inventoried like any [residential move](/services/residential-moving/)",
          "Your belongings are packed into numbered vaults assigned to your account",
          "Storage bills monthly  -  a week between closings or as long as you need",
          "When your new home is ready, the same team delivers everything back",
        ],
      },
      {
      ...
      {
        heading: "Vault Storage vs Self-Storage Units",
        items: [
          "No truck rental and no DIY loading  -  our movers handle pickup and delivery",
          "Vaults are sealed inside a climate-controlled warehouse, not exposed in a drive-up unit",
          "You pay for the vaults you use, not a fixed unit size you may never fill",
          "Access is by appointment  -  if you need daily drive-up access, a self-storage unit may suit you better; for protecting furniture and keepsakes, vault storage wins",
        ],
      },
    ],
    callout: "Our numbered wooden vault system means your belongings are organized and protected  -  not stacked on a warehouse floor. Each vault is assigned to your account, the rate you start with is the rate you keep, and your first month is free when storage is part of your move.",
    calloutLink: "/storage-offer/",
    calloutLabel: "See the Free First Month Offer",
    faq: [
      { q: "Do you have storage units in Enfield, CT?", a: "Yes. Our 5,000 sq ft climate-controlled storage facility is at 4 Niblick Rd, Unit A in Enfield. Instead of drive-up units, we use secure numbered wooden vaults inside the warehouse: our crew picks up your belongings, stores them, and delivers them back when you are ready." },
      { q: "Is your storage climate-controlled?", a: "Yes. The facility holds a steady temperature between 55 and 85 degrees with regulated humidity year-round, which protects wood furniture, electronics, artwork, and anything else sensitive to Connecticut's temperature swings." },
      { q: "Can you move my house and store my belongings?", a: "Yes, that is exactly what our storage is built for. Moving and storage happen under one roof: the crew that loads your truck moves your items into our vaults, and the same team delivers them to your new home when it is ready. No handoff to a third party." },
      { q: "How does pricing work?", a: "Storage is billed monthly based on the number of vaults you need, and we estimate that during your move consultation. Your first month is free when storage is part of your move, and we do not raise storage prices on existing customers. The rate you start with is the rate you keep." },
      { q: "How long can I store my items?", a: "As short as a week between closings or as long as you need. Between-closing gaps, renovations, home staging, downsizing, and multi-month storage are all routine for us." },
      { q: "Can I access my items?", a: "Yes. Contact us to schedule access to your vault during business hours." },
      { q: "What is vault storage?", a: "Your belongings are packed into large sealed wooden containers, each numbered and assigned to your account. Vaults keep your items together, protected from dust, and untouched until delivery, rather than stacked loose on a warehouse floor." },
    ],
  ...
  "specialty-moving": {
    ...
    metaTitle: "Specialty Movers in CT | Pianos & Safes | Castle Express",
    metaDesc: "Specialty movers for pianos, gun safes, fine art & white-glove deliveries. Hartford County CT & Western MA. Licensed & insured. (888) 553-4503",
...
export const CITY_PAGES = {
  ...
  "east-windsor-ct": {
    ...
    intro: "Whether you're moving from a condo off Route 5 or a farmhouse on Scantic Road, Castle Express delivers the same professional, reliable, professionally estimated service East Windsor residents have trusted since 2011.",
  ...
  "farmington-ct": {
    ...
    intro: "From the Farmington Valley to the Unionville section, Castle Express has been helping Farmington families relocate with confidence since 2011. Fully licensed, insured, and A+ BBB rated.",
  ...
  "agawam-ma": {
    ...
    intro: "Just across the Connecticut border, Agawam is a quick trip from our Enfield headquarters. Castle Express brings the same licensed, insured, professionally estimated moving service that Hartford County residents have trusted since 2011.",
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Castle Express is family-owned by Joe Caronna since 2011, not a franchise or broker. We provide accurate, detailed estimates with no hidden fees, employ our own professional crews, and maintain a 4.9-star Google rating with over 200 reviews. We're A+ BBB rated and fully licensed.",
  },
  {
